                ...
                return (
                  ...
                  >
                    <img
                      ...
                      className="w-6 h-6"
                      onError={(e) => {
                        e.currentTarget.parentElement!.innerHTML = `<div class="w-6 h-6 rounded-full ${badge.class} flex items-center justify-center text-xs font-bold">${badge.name.charAt(
                          0
                        )}</div>`;
                      }}
                    />
                ...
                {currentActivity ? (
                  <div className="space-y-1">
                    ...
                    {currentActivity.details && (
                      <div className="pl-6 text-sm text-gray-700 dark:text-gray-300">{currentActivity.details}</div>
                    )}
                    {currentActivity.state && (
                      <div className="pl-6 text-sm text-gray-700 dark:text-gray-300">{currentActivity.state}</div>
                    )}
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">Şu anda herhangi bir aktivite yok</div>
                )}
              </div>
